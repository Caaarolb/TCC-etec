            ...
            {isAuthenticated &&
              (usuario.id === 20 || usuario.usuario === 'admin@admin.com') && (
                <button
                  ...
                  className="text-sm font-semibold relative border rounded-xl p-1 shadow-3xl flex items-center justify-center bg-verde hover:shadow-xl duration-300 cursor-pointer w-60 h-9 transform hover:scale-105"
                >
